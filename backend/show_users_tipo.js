...
(async ()=>{
  ...
  const [rows] = await conn.query(`SELECT u.idusuario, u.nombre, u.tipo_id, u.secret, t.nombre as tipo_nombre FROM usuarios u LEFT JOIN tipo_usuario t ON t.idtipo = u.tipo_id LIMIT 50`);
